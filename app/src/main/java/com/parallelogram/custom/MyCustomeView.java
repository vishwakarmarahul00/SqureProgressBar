...
public class MyCustomeView extends View {
    ...
    public MyCustomeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);


    }

    public MyCustomeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public MyCustomeView(Context context, float xvalue, int i, float barWidths, float barHeights, int barColor) {
        super(context);
